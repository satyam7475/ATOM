"""
ATOM V3 Orchestrator.

This script launches the multi-process architecture of ATOM.
It starts the ZMQ Broker, then spawns the STT, TTS, and LLM workers,
and finally launches the main ATOM core process with the --v3 flag.
...
def main():
    logger.info("Starting ATOM V3 Multi-Process Architecture...")
    ...
    try:
        ...
        logger.info("Starting ATOM Core (main.py --v3)...")
        main_proc = subprocess.Popen([sys.executable, "main.py", "--v3"])
        ...
        logger.info("Shutting down ATOM V3...")
    finally:
        ...
        logger.info("ATOM V3 shutdown complete.")
