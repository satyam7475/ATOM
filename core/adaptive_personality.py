...
_ACTION_TEMPLATES: dict[str, list[str]] = {
    ...
    "music_play": ["Playing.", "Music's back on.", "Resumed."],
    "music_pause": ["Paused.", "Music on hold.", "Holding the music."],
    "music_next": ["Next track.", "Skipping ahead.", "Coming up next."],
    "music_prev": ["Previous track.", "Going back.", "Replaying the last one."],
    "music_play_specific": ["Playing {detail}.", "Cueing up {detail}.", "{detail} coming up."],
    ...
    "next_window_in_app": ["Next window.", "Cycled."],
    "switch_space": ["Switched space.", "Moved over."],
